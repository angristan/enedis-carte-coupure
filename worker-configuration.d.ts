/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 9da2e872b6a4b34dd1aee36603eb677a)
// Runtime types generated with workerd@1.20260630.1 2026-07-07 
interface __BaseEnv_Env {
	...
	OUTAGE_CACHE_STALE_TTL: "7d";
	APP_ENV: "production";
	APP_ORIGIN: "https://enedis.stanislas.cloud";
	TURNSTILE_HOSTNAME: "enedis.stanislas.cloud";
	TURNSTILE_SITE_KEY: "0x4AAAAAAD6CldUPZkyTMsi9";
	SESSION_TTL: "30m";
	CURSOR_TTL: "10m";
	TURNSTILE_SECRET_KEY: string;
	SESSION_SIGNING_SECRET: string;
	CURSOR_SIGNING_SECRET: string;
	UPSTREAM_COORDINATOR: DurableObjectNamespace<import("./worker/index").UpstreamCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "UpstreamCoordinator";
	}
